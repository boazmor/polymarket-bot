...
class Polymarket5mDualBot:
    ...
    def print_status(self) -> None:
        ...
        print(f"ENTRY RULE   : bot40 0-{BOT40_LIMIT_END_SEC}s<={BOT40_LIMIT_PRICE:.2f} then to {BOT40_MAX_SEC}s<={BOT40_FALLBACK_PRICE:.2f} | if dist>={BOT40_FLOW_DIST_THRESHOLD:.0f} only with flow | bot120 {BOT120_MIN_SEC}-{BOT120_MAX_SEC}s dir-only dist>={MIN_DIST_BOT120:.0f} no price cap | usd={MAX_VIRTUAL_BUY_USD:.0f}")
