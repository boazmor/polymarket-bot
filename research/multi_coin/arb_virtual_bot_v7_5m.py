#!/usr/bin/env python3
"""
arb_virtual_bot_v7_5m.py — Polymarket + Predict.fun arbitrage simulator.
...
Output: /root/arb_v7_5m_predict_trades.csv

Run:
  screen -dmS arb_v5 python3 /root/arb_virtual_bot_v7_5m.py
"""
import csv
import os
import subprocess
...
P = "/root/research/multi_coin/data_btc_5m_research/combined_per_second.csv"
PR = "/root/data_predict_btc_5m/combined_per_second.csv"
...
STATE_FILE = "/root/arb_v7_5m_state.json"
...
def lookup_predict_winner(market_id):
    ...
    try:
        ...
        try:
            ...
            return None
        market_open = (first_epoch // 300) * 300
