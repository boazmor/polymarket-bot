#!/usr/bin/env python3
"""
arb_virtual_bot_v6_1h.py — Polymarket + Predict.fun arbitrage simulator.
...
Output: /root/arb_v6_3way_trades.csv

Run:
  screen -dmS arb_v5 python3 /root/arb_virtual_bot_v6_1h.py
"""
import csv
import os
import subprocess
...
LIMITLESS_LATEST = "/root/data_limitless_btc_1h/latest.json"
...
P = "/root/data_btc_1h_research/combined_per_second.csv"
PR = "/root/data_predict_btc_1h/combined_per_second.csv"
PM_OUTCOMES = "/root/data_btc_1h_research/market_outcomes.csv"
LOG = "/root/arb_v6_3way_trades.csv"
...
STATE_FILE = "/root/arb_v6_3way_state.json"
...
def render_status(p, pr):
    ...
    out.append(f"{ANSI_BOLD}ARB_V6_1H — Polymarket + Predict.fun{ANSI_RESET}  "
