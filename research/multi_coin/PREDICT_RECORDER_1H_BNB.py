...
Run:
    python3 PREDICT_RECORDER_1H_V2.py --data-dir /root/data_predict_bnb_1h
"""
...
DATA_DIR = "/root/data_predict_bnb_1h"
...
def slug_for_market_open(market_open_epoch: int) -> str:
    ...
    Slug format observed: bnb-up-or-down-{month}-{day}-{year}-{hour}{am|pm}-et
    ...
    return f"bnb-up-or-down-{month_tag}-{et_dt.day}-{et_dt.year}-{hour_tag}-et"
